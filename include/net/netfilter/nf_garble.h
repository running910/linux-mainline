...
extern void garble_insert_tcp_packet(__be32 saddr, __be32 daddr, __be16 sport, __be16 dport, const struct net *net);

extern void garble_insert_tcp_packet_v6(const struct in6_addr *saddr, const struct in6_addr *daddr, __be16 sport, __be16 dport, const struct net *net);

extern void garble_insert_udp_packet(struct sk_buff *skb, int reverse, struct net *net);
