...
static const char * const garble_tcp_obf_proto_names[][GARBLE_OBF_PROTO_NAME_MAX] = {
	...
	[TCP_OBF_HTTP_SEARCH_TIEBA] = { "http_search_tieba", "search_tieba" },
	[TCP_OBF_HTTP_SEARCH_C_TIEBA] = { "http_search_c_tieba", "search_c_tieba" },
	[TCP_OBF_HTTP_SEARCH_DEEPSEEK_SCHOLAR] = { "http_search_deepseek_scholar", "search_deepseek_scholar" },
	[TCP_OBF_HTTP_SEARCH_DEEPSEEK_KNS] = { "http_search_deepseek_kns", "search_deepseek_kns" },
	[TCP_OBF_HTTP_SEARCH_ICOURSE163] = { "http_search_icourse163", "search_icourse163" },
	[TCP_OBF_HTTP_SEARCH_MOOC_STUDY_163] = { "http_search_mooc_study_163", "search_mooc_study_163" },
	[TCP_OBF_HTTP_SEARCH_KE_QQ] = { "http_search_ke_qq", "search_ke_qq" },
	[TCP_OBF_HTTP_SEARCH_H5_KE_QQ] = { "http_search_h5_ke_qq", "search_h5_ke_qq" },
	[TCP_OBF_HTTP_SEARCH_XHS_WWW] = { "http_search_xhs_www", "search_xhs_www" },
	[TCP_OBF_HTTP_SEARCH_XHS_API] = { "http_search_xhs_api", "search_xhs_api" },
	[TCP_OBF_HTTP_SEARCH_XHS_CREATOR] = { "http_search_xhs_creator", "search_xhs_creator" },
	[TCP_OBF_HTTP_SEARCH_XIMALAYA_MOBILE] = { "http_search_ximalaya_mobile", "search_ximalaya_mobile" },
	[TCP_OBF_HTTP_SEARCH_XIMALAYA_API] = { "http_search_ximalaya_api", "search_ximalaya_api" },
	[TCP_OBF_HTTP_SEARCH_OPEN_163] = { "http_search_open_163", "search_open_163" },
