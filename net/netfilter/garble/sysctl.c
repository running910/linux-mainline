...
static int garble_udp_obf_proto = 0;                    // UDP obfuscation proto: 0=turn allocate request, 1=wechat live video, 2=sip invite, 3=dtls client hello, 4=turn create permission, 5=turn allocate error response, 6=turn channel bind, 7=tftp rrq
